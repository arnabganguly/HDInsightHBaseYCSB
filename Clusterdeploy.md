...
11. Repeat  the same steps again to create a second HDInsight HBase cluster , this time without Accelerated writes by choosing a 
- *normal blob storage account that is recommended by default* and *keeping the 
- **Enable Accelerated Writes** checkbox unchecked* on the storage tab. 
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTUwNTkwNDkwNywtNDg1MzQ2NzEsMTAzOD
